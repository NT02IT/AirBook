 ...
 * @author agond
 */
public class PuTicketImportAD extends javax.swing.JFrame {

    /**
     * Creates new form TicketImportAD
     */
    public PuTicketImportAD() {
        initComponents();
...
//        pnTicketList.setBackground(this.getContentPane().getBackground());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PuTicketImportAD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PuTicketImportAD().setVisible(true);
            }
        });
    }
